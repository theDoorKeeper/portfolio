...
export const Projects = () => {
    return (
        <div className="project-container">
            ...
            Technologies used : <img className="technology" src={react}/>   <img className="technology" src={html}/>   <img className="technology" src={css}/> .<br/>
            Desc : shopping cart made with react an react router dom , used framer motion for the animations , it has a navabar with the number of items purchased next to 
            ...
            i used lifted states to send the data between components . (i was going to use USeContext , but decided it was'nt needed in this project).
             </div>
            ...
            from said array , useEffect is used to render the inital predetrmined card set on mount , and then to change it depending on the array changes , it also
            includes a score board that displays your current and highscore .
            </div>
            ...
            <div className="project-description">
            Technologies used : <img className="technology" src={react}/>   <img className="technology" src={html}/>   <img className="technology" src={css}/>. <br/>
            Desc : this is my first react project , it was initialy made with class components then refractored using Functional components and useState , it was challeging
            ...
            of the differences between useState and setState , i learned alot during this process .
            </div>
            ...
            <img src={weather}></img>
            <div className="project-description">
            Technologies used : <img className="technology" src={js}/>   <img className="technology" src={html}/>   <img className="technology" src={css}/>. <br/>
            Desc: Simple JS weather App , used async await syntax to fetch data from the OpenWeather API (i understand that pushing an API key is dangerous and should'nt be done ,
            ...
            aswell as each todo , you can check the todo if done , each project is generated dinamically , and the code is respecting OOP principles with each part
            of a different  logic in its own module , factory functions have been used for the todos and the projects .
            </div>
            ...
            <div className="project-description">
            Technologies used : <img className="technology" src={js}/>   <img className="technology" src={html}/>   <img className="technology" src={css}/>. <br/>
            Desc: simple tic tac toe game , with the computer making random moves , this project was great for practicing the module patter and factory functions !
            </div>
